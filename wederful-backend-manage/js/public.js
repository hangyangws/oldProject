...
(function($) {
    ...
    var gVar = {
        ...
        remaindCss: '<div class="middle remaind-wrap r4 ofh">' +
            ...
            '<span id="confirmRemaind" class="ts4">确定</span>' +
            '</div>',

        upCss: '<div style="height: 340px" class="sign-m offset-top ts4 middle w300 p5 fs12">' +
            '<div class="c">' +
            '<span style="color: #999" class="sign-x w20 h20 pr fr cp ts4" title="关闭窗口"></span>' +
            '</div>' +
            '<h4 class="fcm tac fs18 mt10 mb15">注册</h4>' +
            '<label class="db b1e0 h30 bcf mb15 ml30 mr30">' +
            '<span class="sign-num fl h1 tac">+86</span>' +
            ...
            '<button style="height: 32px" class="sign-ver-up fr w100 b1m fcf bcm tac ts4">发送验证码</button>' +
            '</div>' +
            ...
            '</div>' +
            '<button class="sign-up-s sign-s db b1m h30 bc bcm fcf fs14 ts4">注册</button>' +
        ...
        inCss: '<div style="height: 280px" class="sign-m offset-top ts4 middle w300 p5 fs12">' +
            '<div class="c">' +
            '<span style="color: #999" class="sign-x w20 h20 pr fr cp ts4" title="关闭窗口"></span>' +
            '</div>' +
            '<h4 class="fcm tac fs18 mt10 mb15">登录</h4>' +
            ...
            '</div>' +
            '<button class="sign-in-s sign-s db h30 b1m bc bcm fcf fs14 ts4">登录</button>' +
            '<div class="ml30 mt10 sign-err"></div>' +
            '</div>',

        reCss: '<div style="height: 285px" class="sign-m offset-top ts4 middle w300 p5 fs12">' +
            '<div class="c">' +
            '<span style="color: #999" class="sign-x w20 h20 pr fr cp ts4" title="关闭窗口"></span>' +
            '</div>' +
            '<h4 class="fcm tac fs18 mt10 mb15">重置密码</h4>' +
            '<label class="db b1e0 h30 bcf mb15 ml30 mr30">' +
            '<span class="sign-num fl h1 tac">+86</span>' +
            '<input class="sign-tel lh200 fl h1 pl10 pr10" type="tel" placeholder="输入手机号" maxlength="11" />' +
            '</label>' +
            '<div class="c ml30 mr30 mb15">' +
            '<input class="sign-ver h1 h30 b1e0 pl10 pr10 bcf lh200 w80 h1" type="text" maxlength="6" placeholder="输入验证码" />' +
            '<button style="height: 32px" class="sign-ver-re fr w100 b1m fcf bcm tac ts4">发送验证码</button>' +
            '</div>' +
            ...
            '</label>' +
            '<button class="sign-re-s sign-s db b1m h30 bc bcm fcf fs14 ts4">完成</button>' +
            '<div class="ml30 mt10 sign-err"></div>' +
            '</div>',
