...
var syncRequest = require('sync-request'),
    ...
    _export = {
        ...
        getCart: (_userId) => {
            var returnData = _export.syncReq({
                method: 'GET',
                url: `/app/cust/cart/sum?memberid=${_userId}`
            });
            ...
            return {
                totalCount: returnData.data.data.totalCount,
                totalAmount: returnData.data.data.totalAmount.toFixed(2)
            };
        },
        dinType: {
            TAKE: '上门取餐',
