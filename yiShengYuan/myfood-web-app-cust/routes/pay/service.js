...
module.exports = {
    index: (req, res) => {
        ...
        var sParaTemp = { // 基本参数
            ...
            return_url: `${payConf.return_url}?expectedtime=${_data.expectedTime}&device=${_data.device}` + (_data.discountId ? `&discountid=${_data.discountId}` : ''),
    ...
    return: (req, res) => {
        ...
        alipayVerity(params, status => {
            ...
            res.render('pay/return', _returnData);
        });
    },
    notify: (req, res) => {
        // 参考支付宝开放平台文档中心
